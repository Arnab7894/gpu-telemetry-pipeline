...
*/}}
{{- define "telemetry-streamer.chart" -}}
...
*/}}
{{- define "telemetry-streamer.componentLabels" -}}
{{ include "telemetry-streamer.labels" . }}
...
*/}}
{{- define "telemetry-streamer.componentSelectorLabels" -}}
{{ include "telemetry-streamer.selectorLabels" . }}
app.kubernetes.io/component: {{ .component }}
{{- end }}
